...
const PdfGenerationTemplateOne = ({ userId, aboutAIs, skillsAi }) => {
    ...
    async function downloadPDF() {
        ...
        // get profile data 
             ...
             <div class="wrapper">
                 ...
                 <div class="row" style="color: black;">
                     <div class="col-md-3 text-center">
                             <img src="${base64Image}" alt="profile-image" style="width: 120px; height: 120px; margin-top: 10px; border-radius: 50%;">
                     ...
                     <div class="col-md-3 p-0 " style="border-right: 1px solid #f59e0b; color: white;">
                         ...
                         <div>
                             ...
                             <div class="text-center" style="color: black;">
                                 <!-- loop -->`: '<div>'
                                 skillsAi.length > 0 ?
                                 skillsAi.filter((skill) => skill.checked === true)
                                 .map((skill, index) => {
                                             template += `
                                     <p>${skill.skill}</p>
                                 ` 
         ...
         <div style="padding-left: 40px; padding-right: 40px; ">
             ...
             <p style="padding-left: 10px; font-size: 14px;"><ul><li>${internship.description}</li></ul></p>
         </div>`;
                 });
