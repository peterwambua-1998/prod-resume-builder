...
const GeneratePDF = ({userId, aboutAI, skillsAi}) => {
    ...
    async function downloadPDF() {
        ...
        let base64Image;
        if (profile.file_url) {
            base64Image = getBase64Image(document.getElementById('profile-temp-three'))
        } else {
            ...
            <div>
                <div style="background-color: white; padding: 2.5rem; border-top: 4px solid #d97706;">
                    ...
                    <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                        <img src="${base64Image}" width="80" height="80" alt="profile" style="border-radius: 50%;">
        ...
        template += `
                    ...
                    <!-- Education -->
                    <div style="border-bottom: 1px solid #808080; margin-bottom: 1rem; padding-bottom: 1rem;">
