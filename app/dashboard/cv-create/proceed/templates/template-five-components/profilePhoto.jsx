...
const ProfilePhoto = ({userId}) => {
    ...
    return (  
        ...
        : (fileUrl) ? <Image alt="profile" id="profile-temp-five" src={fileUrl} width={120} height={120} className={'rounded-full w-[40px] h-[40px] md:w-[100px] md:h-[100px] lg:w-[120px] lg:h-[120px]'} />
